import { mutedColors } from '@/resources/styles/styles'
...
const EmptyStateIllustration: React.FC<EmptyStateIllustrationProps> = ({ isDark, ...props }) => {
  const darkColor = isDark
    ? mutedColors.dark.muted // dark background
    : mutedColors.light.muted // light background
  const lightColor = isDark
    ? mutedColors.dark.mutedForeground // dark foreground
    : mutedColors.light.mutedForeground // light foreground
